...
//Cambiar en dependencas al compilar chainlink-> contracts -> src -> v0.8 -> AggregatorV3Interface 
//cambiar lastRoundData() modificar la variable del segundo parametro de int a uin256
